...
Heparan sulfate is a type of glycosaminoglycan that presents on the surface of most human cells and in the extracellular matrix. The function of heparan sulfate requires a series of modifications, such as 6-O-sulfation, which is generated by heparan sulfate 6-O-sulfotransferases (HS6STs). The mammalian genome encodes three HS6STs, but their role in brain function remains poorly understood. We use molecular biology, mouse genetics, and genomic approaches to study the function of HS6STs in the brain. <br> 
